...
total = 0
for filename in glob.iglob('/home/joe/Documents/dem@care/DS1/DemCare2/s27/*.jpeg', recursive=True):
...
if os.path.exists("keypoints(s27).csv") == False:
    create_keypoint_dataset.to_csv('keypoints(s27).csv', mode='a',index=False, header=False)
else:
